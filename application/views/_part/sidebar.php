      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?=base_url()?>index.php/produk">
            <i class="fa fa-th"></i> <span>Manajemen Produk</span>
          </a>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="<?=base_url()?>index.php/penjualan/order"><i class="fa fa-circle-o"></i> Manajemen Order</a></li>
            <li><a href="<?=base_url()?>index.php/penjualan/histori"><i class="fa fa-circle-o"></i> Riwayat Penjualan</a></li>

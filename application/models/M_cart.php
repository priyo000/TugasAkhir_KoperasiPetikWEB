...
class M_cart extends CI_Model {
    ...
    function tambah_isi($idorder,$idproduk,$qty,$ttl){
        $hasil=$this->db->query("INSERT INTO tb_detail_order (id_order,id_produk,kuantitas,total_harga) VALUES ('$idorder','$idproduk','$qty','$ttl')");
        return $hasil;
    }
